...
public class ScannerModel implements Serializable {
    ...
    static class FilterModel {
            ...
            public WritableByteArrayComparableModel(
                ...
                switch (type) {
                    ...
                    case BinaryPrefixComparator:
                        ...
                        // this.value = new String(comparator.getValue());
                        break;
            ...
            public WritableByteArrayComparable build() {
                ...
                switch (ComparatorType.valueOf(type)) {
                    case BinaryComparator: {
                        ...
                        //  comparator = new BinaryComparator(value.getBytes());
                    }
                    break;
                    case BinaryPrefixComparator: {
        ...
        @XmlElement
        WritableByteArrayComparableModel comparator = null;
        @XmlAttribute
        public String value = null;
        @XmlElement
        public List<FilterModel> filters = null;
        @XmlAttribute
        ...
        @XmlAttribute
        public Boolean ifMissing = null;
        @XmlAttribute
        public Boolean latestVersion = null;
        ...
        public FilterModel(Filter filter) {
            ...
            switch (type) {
                ...
                case InclusiveStopFilter:
                    ...
                    //  this.value = new String(((InclusiveStopFilter)filter).getStopRowKey());
                ...
                case PrefixFilter:
                    ...
                    //    this.value = new String(((PrefixFilter)filter).getPrefix());
                    break;
                ...
                case SingleColumnValueFilter: {
                    ...
                    //  this.family = new String(scvf.getFamily());
        ...
        public Filter build() {
            ...
            switch (FilterType.valueOf(type)) {
                ...
                case InclusiveStopFilter: {
                    ...
                    //filter = new InclusiveStopFilter(value.getBytes());
                }
                break;
                case PageFilter: {
                ...
                case PrefixFilter: {
                    ...
                    //filter = new PrefixFilter(value.getBytes());
                }
                break;
                case QualifierFilter: {
                ...
                case SingleColumnValueFilter: {
                    ...
                    // filter = new SingleColumnValueFilter(family.getBytes(),qualifier!=null?qualifier.getBytes():null,CompareOp.valueOf(op),comparator.build());
                    if (ifMissing != null) {
