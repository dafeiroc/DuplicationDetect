...
import yottabox.hbasemodel.CellModel;
import yottabox.hbasemodel.CellSetModel;
import yottabox.hbasemodel.RowModel;
...
public class ScannerInstanceResource extends ResourceBase {
    ...
    @GET
    @Produces({MIMETYPE_XML, MIMETYPE_JSON})
...
//        response.header("X-Row",new String(value.getRow()));
//        response.header("X-Column",new String(value.getColumn()));
